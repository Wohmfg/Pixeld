...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,web-production-79bf2a.up.railway.app,pixle.site,www.pixle.site').split(',')

CSRF_TRUSTED_ORIGINS = os.environ.get(
    'CSRF_TRUSTED_ORIGINS',
    'https://web-production-79bf2a.up.railway.app,https://pixle.site,https://www.pixle.site',
).split(',')
